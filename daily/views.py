...
def entry_52(request):
    entry = Journal.objects.get(pk=52)
    return render(request, 'daily/entry_52.html', {'entry':entry})

def entry_53(request):
    entry = Journal.objects.get(pk=53)
    return render(request, 'daily/entry_53.html', {'entry':entry})

def entry_54(request):
    entry = Journal.objects.get(pk=54)
    return render(request, 'daily/entry_54.html', {'entry':entry})

def entry_55(request):
    entry = Journal.objects.get(pk=55)
    return render(request, 'daily/entry_55.html', {'entry':entry})

def entry_56(request):
    entry = Journal.objects.get(pk=56)
    return render(request, 'daily/entry_56.html', {'entry':entry})

def entry_57(request):
    entry = Journal.objects.get(pk=57)
    return render(request, 'daily/entry_57.html', {'entry':entry})

def entry_58(request):
    entry = Journal.objects.get(pk=58)
    return render(request, 'daily/entry_58.html', {'entry':entry})

def entry_59(request):
	entry = Journal.objects.get(pk=59)
	return render(request, 'daily/entry_59.html', {'entry':entry})

def entry_60(request):
	entry = Journal.objects.get(pk=60)
	return render(request, 'daily/entry_60.html', {'entry':entry})

def entry_61(request):
	entry = Journal.objects.get(pk=61)
	return render(request, 'daily/entry_61.html', {'entry':entry})
